...
import type { ColorProps, FlexboxProps, SpaceProps, BorderProps, BackgroundProps, OutlineProps, LayoutProps, ExtraProps, ShadowProps, PositionProps } from '../../types';
import type { ResponsiveValue } from '../../../components/types';
import type { ISizes } from '../../../theme/base/sizes';
import type { IColors } from '../../../theme/base/colors';
export interface ISwitchProps extends SwitchProps, ColorProps, SpaceProps, FlexboxProps, PositionProps, ExtraProps, OutlineProps, ShadowProps, LayoutProps, BackgroundProps, BorderProps {
    /**
