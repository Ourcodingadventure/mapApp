...
export interface IIconProps extends Omit<SvgProps, 'opacity' | 'fill' | 'stroke' | 'height' | 'width' | 'transform' | 'color'>, BorderProps, ColorProps, FlexboxProps, LayoutProps, PositionProps, SpaceProps, TypographyProps, ExtraProps, OutlineProps, ShadowProps, BackgroundProps, SafeAreaProps, TransformProps, PlatformProps<IIconProps> {
    /**
