...
declare const _default: React.MemoExoticComponent<React.ForwardRefExoticComponent<import("../../primitives/Box").IBoxProps<ICircularProgressProps> & {
    ...
    value: number;
    size?: import("../../types").ResponsiveValue<number | "px" | "sm" | "md" | "lg" | "xl" | "0" | "1" | "2" | "4" | "8" | "2xl" | "xs" | "full" | "3" | "5" | "6" | "7" | "9" | "0.5" | "1.5" | "2.5" | "3.5" | "10" | "12" | "16" | "20" | "24" | "32" | "40" | "48" | "56" | "64" | "72" | "80" | "96" | "1/2" | "1/3" | "2/3" | "1/4" | "2/4" | "3/4" | "1/5" | "2/5" | "3/5" | "4/5" | "1/6" | "2/6" | "3/6" | "4/6" | "5/6" | "container" | "3xs" | "2xs" | (string & {})>;
