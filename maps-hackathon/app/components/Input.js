...
import { EvilIcons, MaterialCommunityIcons } from '@expo/vector-icons';
 ...
 const  SearchInput = React.forwardRef(({ inputContainerStyle, setRef , onSubmitEditing,CustomIcon, inputStyle, onChangeText, iconName, iconSize = 20, color = 'gray', iconStyle, placeholder = '', value, ...otherProps },ref) =>{
